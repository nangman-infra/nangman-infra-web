...
export default function MembersPage() {
  ...
  const copy =
    locale === "ko"
      ? {
          title: "함께하는 사람들",
          subtitle: "인프라를 지탱하는 커뮤니티 구성원을 소개합니다",
          fallbackNotice: "실시간 멤버 정보를 불러오지 못해 로컬 정보를 표시하고 있습니다.",
          seniors: "멘토",
          mentees: "멘티",
        }
      : {
          title: "Members",
          subtitle: "Meet the people who sustain the community behind the infrastructure.",
          fallbackNotice: "Live member data is unavailable, so local fallback data is being shown.",
          seniors: "Mentors",
          mentees: "Mentees",
        };
        ...
        animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl md:text-3xl font-bold">{copy.seniors}</h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 md:auto-rows-fr gap-6 md:gap-8">
              ...
              >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold">{copy.mentees}</h2>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:auto-rows-fr gap-6 md:gap-8">
